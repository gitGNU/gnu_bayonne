...
\cmd{ignore {\it events... or none} \\
	Used to ignore received events in the scripting language.  The ignore
	mask takes effect in subroutines as well.  It is automatically cleared
	(set to ``none'') on a goto.
